...
void Histogram::Fill_trigger(const std::shared_ptr<Branches12>& _d) {
  ...
  if (trigger & (1<<21)&ft_cal_energy)_21_ft_cal_energy->Fill(_d->ft_cal_energy(0));
  else if (trigger&ft_cal_energy)  _n21_ft_cal_energy->Fill(_d->ft_cal_energy(0));
  
  if(trigger & ft_cal_energy)trigger_vs_ft_cal_energy->Fill(_d->trigger(0),_d->ft_cal_energy(0));
}
